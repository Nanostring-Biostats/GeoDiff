...
NBthmDE_uOpt <-
  function(u0, X, Z, y, alpha0, alpha, x, preciu, calhes) {
...
PoisthNorm_paraOptfeat <-
  function(y,
           ...
           calhes) {
    .Call(
      `_GeoDiff_PoisthNorm_paraOptfeat`,
      y,
      X,
      alpha0,
      alpha,
...
PoisthNorm_paraOptall <-
  function(Y,
           ...
           calhes) {
    .Call(
      `_GeoDiff_PoisthNorm_paraOptall`,
      Y,
      X,
      alpha0,
      alpha,
